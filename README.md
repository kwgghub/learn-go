...
小白学 Go 是一个专为编程小白设计的 **Go 语言入门学习平台**。无需安装环境，打开浏览器就能学 Go，一题一练，循序渐进，从 Hello World 到并发编程，带你轻松入门 Golang。
...
*精美的首页，粒子动画背景，呼吸灯标题效果 — 小白学 Go，从零开始学 Golang*
...
### 后端
- **Gin 框架** — 高性能 HTTP 路由框架
- **gin-contrib/cors** — CORS 跨域支持
- **沙箱执行** — 临时目录隔离，自动清理
...
Go语言入门, Go教程, Go入门教程, 小白学Go, Golang教程, Golang入门, 交互式编程, 在线编程, 编程入门, 零基础学Go, Go语言实战, Go语言练习, 代码运行, 自动判分, Go学习平台
